...
#         if ingredient not in available or available[ingredient] // count == 0:
#             return 0
#         how_much = available[ingredient] // count
#         min_cakes = min(min_cakes, how_much)
#     return min_cakes


if __name__ == "__main__":
    recipe = {"sugar": 200, "flour": 500,  "eggs": 1}
